...
function AddProject() {
    ...
    return (
        <div>
            ...
            {!openUrlInput ?
                <button className='btn btn-secondary w-full' onClick={()=>setOpenUrlInput(true)}>+ Add New Project / Startup</button>
                :
                ...
                <form onSubmit={handleSubmit} className='p-3 rounded-lg bg-gray-800'>
                    ...
                    <button type='submit' disabled={loading} className='btn btn-secondary w-full'>+ Add New Project / Startup</button>
                </form>}
        </div>
    )
}
