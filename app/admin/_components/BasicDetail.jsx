...
const BASE_URL='https://firebasestorage.googleapis.com/v0/b/projects-85427.appspot.com/o/'
  ...
  return (
    <div className='p-7 rounded-lg bg-gray-800 my-7'>
        <div className='flex gap-6 items-center'>
            ...
            <input type='file' id='file-input' onChange={handFileUpload} accept='image/png, image/gif, image/jpeg' style={{display:'none'}} />
        ...
        <textarea className="textarea textarea-bordered mt-3 w-full" placeholder="Start writing about yourself" defaultValue={userDetail?.bio} onChange={(event)=>onInputChange(event,'bio')}></textarea>

        <div>
            <div className='flex gap-3 mt-6'>
                <MapPin className={`h-12 w-12 p-3 text-blue-500 rounded-md hover:bg-gray-600 ${selectedOption=='location'&&'bg-gray-600'}`} onClick={()=>setSelectedOption('location')}/>
                <Link2 className={`h-12 w-12 p-3 text-yellow-500 rounded-md hover:bg-gray-600 ${selectedOption=='link'&&'bg-gray-600'}`} onClick={()=>setSelectedOption('link')}/>
            </div>
